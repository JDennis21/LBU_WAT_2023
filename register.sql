...
INSERT INTO `register` (`regID`, `regUser`, `regEmail`, `regPass`, `regAge`)
VALUES (46, 'JDennis21', 'J.dennis@student.leedsbeckett.ac.uk', '11c907f58c553ebf916d5d52f12b4c7b', '18 to 30'),
...
--
ALTER TABLE `register`
    MODIFY `regID` int(8) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 50;
COMMIT;
